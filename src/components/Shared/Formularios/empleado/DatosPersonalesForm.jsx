            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-5">
                ...
                <div className="md:col-span-4">
                    ...
                    <select
                        ...
                        className="w-full p-2.5 text-sm text-secondary border border-slate-300 rounded-lg focus:ring-1 focus:ring-primary focus:border-primary outline-none bg-white font-medium"
                    >
                ...
                <div className="md:col-span-12">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            onChange={(e) => onChange('direccion', toUpper(e.target.value))}
                            className="w-full pl-9 p-2.5 text-sm text-secondary border border-slate-300 rounded-lg focus:ring-1 focus:ring-primary focus:border-primary outline-none"
